...
//    static var mockWorkout: Yoga = Yoga(exercises: [], workoutState: .onProgress, date: Date.now)
    ...
    static var yogas =
        Yoga(id: UUID(), name: "Yoga 1", poses: [
            ...
            Pose(id: UUID(), name: "Pose2", difficulty: .beginner, exception: [.vertigo], recommendedTrimester: .all, relieve: [.leg], description: "Desc 1", seconds: 12, state: .completed),
