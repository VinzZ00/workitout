...
#Preview {
    VStack(spacing: 20){
        Text("Completed State")
            .bold()
        PoseCard(pose : PoseHistory(id: UUID(), name: "Banana", altName: "Banana", category: .standingPose, difficulty: .beginner, description: "Banana", seconds: 60, state: .completed))
        Text("Skipped State")
            .bold()
        PoseCard(pose : PoseHistory(id: UUID(), name: "Banana", altName: "Banana", category: .standingPose, difficulty: .beginner, description: "Banana", seconds: 60, state: .completed))
    }
