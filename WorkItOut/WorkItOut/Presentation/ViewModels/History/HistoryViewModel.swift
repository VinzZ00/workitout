...
class HistoryViewModel : ObservableObject {
    ...
    init(){
        ...
        self.histories.append(History(id: UUID(), yogaDone: [yoga], executionDate: Date.now, duration: 10, rating: 5))
        self.histories.append(History(id: UUID(), yogaDone: [yoga], executionDate: Calendar.current.date(byAdding: .day, value: 1, to: Date.now)!, duration: 10, rating: 5))
        self.histories.append(History(id: UUID(), yogaDone: [yoga], executionDate: Calendar.current.date(byAdding: .day, value: 1, to: Date.now)!, duration: 10, rating: 5))
